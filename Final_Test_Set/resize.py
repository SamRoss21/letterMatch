...
def test_one(img1_name):
	...
	#crop tree image
	cropped1 = get_bounding_rect_for_isolated_obj(img1, img1, 'OpenCV_Testing', img1_name)
	#print(cropped1)
	...
	resized1 = img_resize(cropped1)


##########################################################
for filename in os.listdir('./Wide_Filled'):
	if not filename.startswith('.'):
		test_one('./Wide_Filled/'+ str(filename))
